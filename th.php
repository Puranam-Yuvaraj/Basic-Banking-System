...
.btn{
    background-color: rgb(180, 224, 248);
    border-radius: 10px;
    color: black;
    text-align: center;
...
<div class="container"  style= "background-color: rgb(180, 224, 248)" >
        <h2 class="text-center pt-4">Transaction</h2>
        <br>
            
                <div class="col">
                
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style= "background-color: #ffffff">
                        <thead>
                            <tr>
         ...
         <footer class="text1">
        <p>&copy 2021. Made by <b>Yuvaraj</b> </p>
      </footer>
      </div>
    </body>
</html>